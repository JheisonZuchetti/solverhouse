...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2019 a las 05:18:52
...
INSERT INTO `cliente_post` (`id_post`, `id_cliente`, `Nombre`, `Descripcion`, `Foto1`, `Foto2`, `Foto3`, `Presupuesto`, `Solicitud`, `Tipo`, `Profesion`) VALUES
(1, 1, 'TOPOGRAFIA BANCO DE LA  NACION-JAVIER PRADO-COSAPI', 'we need a person who is good at teaching students in cybersecurity skills and penetration testing especially in ceh and SIEM like splunk or logrhythm , you must have excellent knowledge in cybersecurity , the timings for the class will be 19:00 to 21:00 uk time 3 days a week so a total of 6 hours a week please put the words i Understand in your proposal', 'slider1.jpg', 'slider2.jpg', '', 'S/100 - S/200', 'urgente', 'libre', '2'),
(3, 1, 'INSPECCION DE SERVICIO ELECTRICO', 'we need a person who is good at teaching students in cybersecurity skills and penetration testing especially in ceh and SIEM like splunk or logrhythm , you must have excellent knowledge in cybersecurity , the timings for the class will be 19:00 to 21:00 uk time 3 days a week so a total of 6 hours a week please put the words i Understand in your proposal', 'slider1.jpg', 'slider2.jpg', 'start.png', 'S/100 - S/200', 'urgente', 'libre', '2'),
(4, 1, 'INSPECCION DE SERVICIO ELECTRICO', 'i have small problem , using this script : [iniciar sesión para ver URL] everything working good , until i add Arabic language using php-ar using : ImagePrintBuffer from : [iniciar sesión para ver URL] so before i can send multi commands to printers without any problem now the problem after i add php-ar , after first command the script stop working and [iniciar sesión para ...', 'slider2.jpg', '', '', 'S/100 - S/200', 'urgente', 'libre', '1'),
(5, 1, 'TOPOGRAFIA BANCO DE LA  NACION-JAVIER PRADO-COSAPI', 'holaaaaaaa', 'slider1.jpg', 'slider2.jpg', '', 'S/100- S/200', 'urgente', 'libre', '2'),
(6, 1, 'Cortar cesped y podar algunas plantas ', 'Requiero de un jardinero que me ayude en labor de la cas apara poder podar el cesped y aparte de eso tenemos un árbol al frente de nuestra casa que temo se puede caer ,por eso quiero que un experto pueda cortarlo sin  causar daños en nuestra casa , espero su respuesta de manera urgente ', 'slider1.jpg', 'slider2.jpg', 'start.png', 'S/200 - S/300', 'urgente', 'libre', '4');
